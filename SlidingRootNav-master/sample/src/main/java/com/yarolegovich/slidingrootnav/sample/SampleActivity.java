...
import com.yarolegovich.slidingrootnav.sample.fragment.ChangeFragment;
import com.yarolegovich.slidingrootnav.sample.fragment.INFO;
import com.yarolegovich.slidingrootnav.sample.fragment.Messages;
import com.yarolegovich.slidingrootnav.sample.fragment.MyAccount;
import com.yarolegovich.slidingrootnav.sample.fragment.PageViewModal;
...
public class SampleActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        changeFragment = new ChangeFragment(SampleActivity.this);
    ...
    public void onItemSelected(int position) {
        ...
        if (position == POS_ACCOUNT){
            changeFragment.change(new MyAccount());

        }else if(position == POS_MESSAGES){
            changeFragment.change(new Messages());
        }
        else {
